...
<script language="Javascript" type="text/javascript">
setTimeout('yourFunction9();', 9000);

function yourFunction9(){
    document.getElementById('phase2').style.display='block';
	document.getElementById('phase22').style.display='block';
	document.getElementById('phase1').style.display='none';
	document.getElementById('phase11').style.display='none';
}
</script>
<script>
function showdiv(id){
...
<div class="box1">
<div id="wrap" style="width:198px;height:auto;margin-left:auto;margin-right:auto;left:0px;right:0px;">
<img id="text1" src="images/1-8.png" style="display:none;width:174px;height:12px;position:relative;margin-top:15px;"/>
<img id="text2" src="images/2-8.png" style="display:none;width:169px;height:12px;position:relative;margin-top:15px;"/>
<img id="text3" src="images/3-8.png" style="display:none;width:188px;height:12px;position:relative;margin-top:15px;"/>
<img id="text4" src="images/4-8.png" style="display:none;width:145px;height:12px;position:relative;margin-top:15px;"/> 
<img id="text5" src="images/5-8.png" style="display:none;width:198px;height:12px;position:relative;margin-top:15px;"/> 
<img id="text6" src="images/6-8.png" style="display:none;width:170px;height:12px;position:relative;margin-top:15px;"/> 
<img id="text7" src="images/7-8.png" style="display:none;width:194px;height:12px;position:relative;margin-top:15px;"/> 
<img id="text8" src="images/8-8.png" style="display:none;width:120px;height:12px;position:relative;margin-top:15px;padding-bottom:15px;"/> 
</div>                                                   
</div>
</div>
...
<div id="phase22" class="footer2" style="display:none;">
